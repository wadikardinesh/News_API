...
//    key = process.env.REACT_APP_NEWS_API;
    ...
    async updateNews() {
        ...
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=78e63c80e0784ee39c60f5e4eecd9453&page=${this.state.page}&pageSize=${this.props.pageSize}`;
